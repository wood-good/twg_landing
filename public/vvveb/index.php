...
// Check if V_SUBDIR_INSTALL is explicitly defined (even as empty string) or fall back to detection
$subdir = (defined('V_SUBDIR_INSTALL') && V_SUBDIR_INSTALL !== false) ? V_SUBDIR_INSTALL : detectSubDir();
